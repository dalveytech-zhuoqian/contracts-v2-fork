...
contract DummyDiamondImplementation {
    ...
    function getFeesReceivable(Tuple21927 memory params, Tuple464693 memory position)
        external
        view
    ...
    function SELF_addMarket(bytes memory data) external returns (uint16 market) {}
    ...
    function getExecutableOrdersByPrice(Tuple2589231 memory cache)
        external
        view
        returns (Tuple564566[] memory _orders)
    {}
    ...
    function blockAndAggregate(bytes[] memory calls)
        external
        returns (uint256 blockNumber, bytes32 blockHash, Tuple557464[] memory returnData)
    {}
    ...
    function tryAggregate(bool requireSuccess, bytes[] memory calls)
        external
        returns (Tuple557464[] memory returnData)
    {}
    ...
    function SELF_addOrders(Tuple8179501[] memory _inputs) external returns (Tuple564566[] memory _orders) {}
    ...
    function SELF_decreasePosition(Tuple8634448 memory inputs) external returns (Tuple3316247 memory result) {}

    function SELF_increasePosition(Tuple8047955 memory _data) external returns (Tuple3316247 memory result) {}

    function SELF_liquidatePosition(uint16 market, address account, uint256 oraclePrice, bool isLong)
        external
        returns (Tuple3316247 memory result)
    {}
