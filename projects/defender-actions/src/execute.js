...
exports.handler = async function (credentials) {
    ...
    calldata[0] = AccessManager.interface.encodeFunctionData('execute', [signerAddress, addressJSON.vaultReward, aprData]);
    calldata[1] = AccessManager.interface.encodeFunctionData('execute', [signerAddress, addressJSON.rewardDistributor, intervalData]);
