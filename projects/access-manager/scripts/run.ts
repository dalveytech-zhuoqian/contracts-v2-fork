...
async function main() {
    ...
    const ProxyAdmin = new ethers.Contract(addressJsonNetwork.proxyAdmin, ProxyAdminABI, owner);
    ...
    await handleTx(ProxyAdmin.transferOwnership(addressJsonNetwork.boss), "transferOwnership to boss");
